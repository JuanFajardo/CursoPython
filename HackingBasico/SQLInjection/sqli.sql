...
('', 'Administrador', 'admin', 'admin@owasp.bo', md5('admin'), '0000000', '00000', '0'),
('', 'FLORENTINA, ABASTO ROSSEL', 'fabasto', 'fabasto@owasp.bo', md5('1385058'), '1385058', '21888', '0'),
('', 'NERIY, ANCE MOLLO', 'nance', 'nance@owasp.bo', md5('4008987'), '4008987', '21897', '0'),
('', 'MARIA LISET, ARANA BARRIOS', 'marana', 'marana@owasp.bo', md5('5137532'), '5137532', '21928', '0'),
('', 'JOSE LUIS, AVENDANO ALVAREZ', 'javendano', 'javendano@owasp.bo', md5('3966565'), '3966565', '21977', '1'),
('', 'ELIZABETH, BALLESTEROS GUZMAN', 'eballesteros', 'eballesteros@owasp.bo', md5('3665272'), '3665272', '22002', '0'),
('', 'WILFREDO, CORO COLQUE', 'wcoro', 'wcoro@owasp.bo', md5('3682942'), '3682942', '22447', '1'),
('', 'ALCIDES VALERIO, CARLO VILLCA', 'acarlo', 'acarlo@owasp.bo', md5('4007681'), '4007681', '22162', '1'),
('', 'LUIS ALBERTO, CALLAPINO LOPEZ', 'lcallapino', 'lcallapino@owasp.bo', md5('6659323'), '6659323', '22125', '1'),
('', 'RUBEN, CALIZAYA PUMA', '', 'rcalizaya@owasp.bo', md5('rcalizaya'), '5555155', '22106', '1'),
('', 'FELICIANO, CABRERA LAURA', 'fcabrera', 'fcabrera@owasp.bo', md5('5537782'), '5537782', '22081', '0'),
('', 'EDSON PAUL, CABA CHOQUE', 'ecaba', 'ecaba@owasp.bo', md5('ecaba'), '6629145', '22064', '0'),
('', 'MARCELO, BUSTILLOS FIGUEROA', 'mbustillos', 'mbustillos@owasp.bo', md5('3669298'), '3669298', '22059', '0'),
('', 'IVAN, BRAVO PACO', 'ibravo', 'ibravo@owasp.bo', md5('5072436'), '5072436', '22051', '0');
